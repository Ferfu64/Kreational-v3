...
export const DEFAULT_GAMES: Game[] = [
  ...
  { id: 'gold_shadow_trick', title: 'Shadow Trick', tier: 'gold', embedCode: '<iframe src="https://labgstore1812.github.io/g66/class-876" width="100%" height="600px" frameborder="0" allowfullscreen scrolling="no" allow="autoplay; gamepad; fullscreen"></iframe>', order: 8 },
  { id: 'gold_tankball', title: 'TankBall', tier: 'gold', embedCode: '<iframe src="https://labgstore1812.github.io/g50/class-4" width="100%" height="600px" frameborder="0" allowfullscreen scrolling="no" allow="autoplay; gamepad; fullscreen"></iframe>', order: 9 },
  ...
  // MYTHIC TIER
  { id: 'mythic_dragbox', title: 'DragBox', tier: 'mythic', embedCode: '<iframe src="https://quiz-13.com/repo1/lesson-58/" width="100%" height="600px" frameborder="0" allowfullscreenscrolling="no" allow="autoplay; gamepad; fullscreen"></iframe>', order: 1 },
